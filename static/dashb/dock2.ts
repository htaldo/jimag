...
import { SbNcbrPartialCharges, SbNcbrPartialChargesPreset, SbNcbrPartialChargesPropertyProvider } from 'molstar/lib/extensions/sb-ncbr';
...
import { RCSBAssemblySymmetryConfig } from 'molstar/lib/extensions/rcsb/assembly-symmetry/behavior';
export { PLUGIN_VERSION as version } from 'molstar/lib/mol-plugin/version';
export { setDebugMode, setProductionMode, setTimingMode, consoleStats } from 'molstar/lib/mol-util/debug';
var CustomFormats = [
    ['g3d', G3dProvider]
];
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        spec = {
                            ...
                            behaviors: __spreadArray(__spreadArray([], defaultSpec.behaviors, true), o.extensions.filter(function (e) { return !disabledExtension.has(e); }).map(function (e) { return ExtensionMap[e]; }), true),
                            ...
                            components: __assign(__assign({}, defaultSpec.components), { controls: __assign(__assign({}, (_b = defaultSpec.components) === null || _b === void 0 ? void 0 : _b.controls), { top: o.layoutShowSequence ? undefined : 'none', bottom: o.layoutShowLog ? undefined : 'none', left: o.layoutShowLeftPanel ? undefined : 'none' }), remoteState: o.layoutShowRemoteState ? 'default' : 'none' }),
                            config: [
